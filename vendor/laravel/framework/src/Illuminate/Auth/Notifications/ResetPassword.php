...
class ResetPassword extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line(Lang::get('Recibes este correo electrónico porque solicitaron un restablecimiento de contraseña para tu cuenta.'))
            ...
            ->line(Lang::get('Si no realizaste esta solicitud, ignora este mensaje.'));
    }
