    ...
    <div class="wrapper " v-cloak v-show="!cargando">
                        ...
                        <div class="nav flex-column nav-pills " id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <div v-if="!cargandoMenu && menuStep == 3">
                             ...
                             <div v-if="!cargandoMenu && menuStep == 4">
                                ...
                                <a class="d-flex align-items-center nav-link cursor-pointer" v-for="obj in herramentales" @click="seleccionarHerramental(obj.id)">
        ...
        <div class="main-panel">
            ...
            <div class="content" style="max-height: 80vh; overflow-y: scroll">
                <div class="row mb-2 ">
                    <div class="col-12">
                        <h2 class="bold my-0 py-1 mb-3 text-decoration-underline" style="letter-spacing: 2px">REPORTE DE FINANZAS (HR)</h2> 
                    </div>
                    <div class="col-12" v-show="!selectedHerramental">
                        <h5 class="text-muted my-4"> SELECCIONE UN HERRAMENTAL PARA VER LOS REPORTES DISPONIBLES</h5>
                    </div>
                    <div class="col-12 text-center pt-5" v-show="selectedHerramental && loading">
                        <h5 class="mt-5 bold" style="letter-spacing: 1px">CARGANDO INFORMACIÓN, ESPERE UN MOMENTO...</h5>
                    </div>
                    <div class="col-lg-12" v-show="selectedHerramental && !loading">
...
<script type="text/javascript">
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            verDetalleRetrasos() {
                this.loading = true;
                axios.get('/api/herramentales/' + this.selectedHerramental + '/retrasos')
                .then(response => {
            ...
            async seleccionarHerramental(herramentalId){
                ...
                try {
                    ...
                    swal({
                        title: "Error",
                        text: "Ha ocurrido un error al obtener los tiempos del herramental, intentelo más tarde.",
                        icon: "error",
                        button: "Aceptar",
                    });
                } finally {
