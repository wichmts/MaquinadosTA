    ...
    <div class="content" id="vue-app">
        ...
        <div class="row" v-cloak v-show="!cargando">
            ...
            <div class="col-xl-10 mt-3">
                ...
                <div class="row">
                    <div class="col-xl-7">
                        <h2 class="bold my-0 py-1 mb-3 text-decoration-underline" style="letter-spacing: 2px">TEMPLE</h2>
                    </div>
                    <div class="col-xl-3 form-group" v-if="selectedHerramental">
                        <select name="" id="" class="form-control" v-model="estatusTemple" @change="fetchComponentes(selectedHerramental)">
                            <option value="-1">TODOS LOS COMPONENTES</option>
                            <option value="1">SIN FECHA DE ENVIO</option>
                ...
                <div class="col-xl-12" v-if="!selectedHerramental">
                    <h5 class="text-muted my-4"> SELECCIONE UN HERRAMENTAL PARA VER LOS COMPONENTES QUE REQUIEREN TEMPLE</h5>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="c in componentes">
                                    <td class="bold">
                                        @{{c.nombre}}<span v-if="c.version > 1">.v2</span> <br>
                                    ...
                                    <td><input class="form-control text-center" type="date"  v-model="c.fecha_envio_temple"></td>
                                    <td><input class="form-control text-center" type="date"  v-model="c.fecha_estimada_temple"></td>
                                    <td><input class="form-control text-center" type="date"  v-model="c.fecha_recibido_temple"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <script type="text/javascript">
        ...
        methods:{
            ...
            async fetchComponentes(herramentalId) {
                ...
                try {
                    const response = await axios.get(`/api/herramentales/${herramentalId}/componentes?area=temple&estatusTemple=${this.estatusTemple}`);
            ...
            async guardarComponentes(mostrarAlerta = true){
                ...
                swal({
                    ...
                    if (willSave) {
                        ...
                        try {
                            const response = await axios.post(`/api/componente/${t.selectedHerramental}/temple`, formData, {
                                headers: {
