            ...
            <div class="col-lg-6" style="border-right: 1px solid #ededed">
                <div class="row">
                    <div class="col-xl-12 mb-4">
                        <h2 class="bold my-0 py-1 text-decoration-underline" style="letter-spacing: 2px">NUEVA ORDEN DE TRABAJO</h2>
                    </div>
                    <div class="col-lg-6 form-group">
                        <label class="bold">Fecha de solicitud</label>
                        <input type="date" class="form-control" v-model="nuevo.fecha_solicitud" readonly>
                    </div>
                    <div class="col-lg-6 form-group">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <select class="form-control" v-model="nuevo.area_solicitud">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" v-model="nuevo.numero_hr">
                        </div>
                    </div>
                    <div class="col-lg-4 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" v-model="nuevo.numero_componente">
                        </div>
                    </div>
                    <div class="col-lg-4 form-group">
                        <label class="bold">Cantidad <span class="text-danger">*</span></label>
                        <input type="number" step="1" class="form-control" v-model="nuevo.cantidad">
                    </div>
                    <div class="col-lg-4 form-group">
                        ...
                        <label tabindex="0" for="2d" class="input-file-trigger col-12 text-center">
                            <i class="fa fa-upload"></i> CARGAR 2D
                        </label>
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <label tabindex="0" for="3d" class="input-file-trigger col-12 text-center">
                            <i class="fa fa-upload"></i> CARGAR 3D
                        </label>
                    ...
                    <div class="col-lg-6 form-group mt-4">
                        <div class="form-check">
                            <label class="form-check-label" style="font-size: 10px">
                                <input type="checkbox" class="form-check-input" v-model="nuevo.tratamiento_termico">
                    ...
                    <div class="col-lg-12 text-center form-group">
                        <button v-if="!cargando" class="btn btn-success" @click="enviar"><i class="fa fa-paper-plane"></i> ENVIAR SOLICITUD</button>
                        <button v-else disabled class="btn btn-success" @click="enviar"><i class="fa fa-spinner"></i> ENVIANDO, ESPERE...</button>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    ...
                    <div class="col-xl-12 table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr v-for="solicitud in solicitudes" class="cursor-pointer">
